...
class OptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.OptionsProto) */ {
 public:
  ...
  static const OptionsProto* internal_default_instance();

  void Swap(OptionsProto* other);

  // implements Message ----------------------------------------------

  inline OptionsProto* New() const { return New(NULL); }

  OptionsProto* New(::google::protobuf::Arena* arena) const;
  ...
  void UnsafeMergeFrom(const OptionsProto& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto_impl();
  friend void protobuf_AssignDesc_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<OptionsProto> OptionsProto_default_instance_;
...
class AdvisorOptionsProto_CheckerOption : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.AdvisorOptionsProto.CheckerOption) */ {
 public:
  ...
  static const AdvisorOptionsProto_CheckerOption* internal_default_instance();

  void Swap(AdvisorOptionsProto_CheckerOption* other);

  // implements Message ----------------------------------------------

  inline AdvisorOptionsProto_CheckerOption* New() const { return New(NULL); }

  AdvisorOptionsProto_CheckerOption* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const AdvisorOptionsProto_CheckerOption& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<AdvisorOptionsProto_CheckerOption> AdvisorOptionsProto_CheckerOption_default_instance_;
...
class AdvisorOptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.AdvisorOptionsProto) */ {
 public:
  ...
  static const AdvisorOptionsProto* internal_default_instance();

  void Swap(AdvisorOptionsProto* other);

  // implements Message ----------------------------------------------

  inline AdvisorOptionsProto* New() const { return New(NULL); }

  AdvisorOptionsProto* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const AdvisorOptionsProto& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<AdvisorOptionsProto> AdvisorOptionsProto_default_instance_;
