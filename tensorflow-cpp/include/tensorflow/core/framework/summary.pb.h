...
class SummaryMetadata_PluginData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SummaryMetadata.PluginData) */ {
 public:
  ...
  static const SummaryMetadata_PluginData* internal_default_instance();
  ...
  void UnsafeMergeFrom(const SummaryMetadata_PluginData& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<SummaryMetadata_PluginData> SummaryMetadata_PluginData_default_instance_;
