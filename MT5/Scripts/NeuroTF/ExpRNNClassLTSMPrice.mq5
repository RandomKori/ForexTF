...
void OnStart()
  {
    ...
    string hdr="s1;s2;s3;s4;s5;s6;s7;s8;s9;s10;s11;s12;s13;s14;s15;s16;s17;s18;s19;s20;l1;l2;l3";
    FileWrite(ot,hdr);
    for(int i=11;i<tr;i++)
    {
      string d="";
      for(int j=0;j<10;j++)
      {
         ...
         double delta1=his[i-j].high;
         double delta2=his[i-j].low;
         d=d+DoubleToString(delta1,15)+";"+DoubleToString(delta2,15)+";";
      }
